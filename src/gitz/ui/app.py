...
_CSS_PATH: str = str(Path(__file__).parent / "gitz.tcss")
...
class GitzApp(App[None]):
    """Main Textual application for GITZ.
    ...
    - GitzFooter (shortcuts, version, sync status)
    ...
    def _refresh_all(self) -> None:
        ...
        footer = self.query_one(GitzFooter)
